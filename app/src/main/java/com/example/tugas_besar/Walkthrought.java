...
public class Walkthrought extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLis.add(new ScreenItem("Easy Read", "Memudahkan dalam membaca buku", R.drawable.img1));
        mLis.add(new ScreenItem("Portability", "Mudah di bawa kemana saja karna bukunya di simpan di smartphone", R.drawable.img2));
        mLis.add(new ScreenItem("Simple", "Mudah dalam mencari buku yang ingin dibaca", R.drawable.img3));
